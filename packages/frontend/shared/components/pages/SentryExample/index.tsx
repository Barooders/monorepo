...
import SentryType from '@sentry/nextjs/types/index.types';
import Link from '@/components/atoms/Link';

type PropsType = {
  sentryInstance: typeof SentryType;
};

const SentryExample = ({ sentryInstance }: PropsType) => {
  return (
    <div>
      <Head>
      ...
      >
        ...
        <p>
          ...
          <Link href="https://barooders.sentry.io/issues/?project=4504893925556224">
            Issues Page
          </Link>
          .
        </p>
