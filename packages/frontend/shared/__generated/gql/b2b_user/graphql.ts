...
export type BundlePrice = {
  ...
  unitPriceInCents: Scalars['bigint']['output'];
};
...
export type BundlePrice_Stream_Cursor_Value_Input = {
  ...
  unitPriceInCents: InputMaybe<Scalars['bigint']['input']>;
};
...
export type Product = {
  ...
  GTINCode: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['timestamp']['output'];
  handle: Maybe<Scalars['String']['output']>;
  productType: Maybe<Scalars['String']['output']>;
  status: Scalars['ProductStatus']['output'];
  /** An object relationship */
  storeB2BProduct: Maybe<Dbt_Store_B2b_Product>;
  /** An object relationship */
...
export type Product_Bool_Exp = {
  ...
  storeB2BProduct: InputMaybe<Dbt_Store_B2b_Product_Bool_Exp>;
...
export type Product_Order_By = {
  ...
  status: InputMaybe<Order_By>;
  storeB2BProduct: InputMaybe<Dbt_Store_B2b_Product_Order_By>;
...
export type Product_Stream_Cursor_Value_Input = {
  ...
  GTINCode: InputMaybe<Scalars['String']['input']>;
  createdAt: InputMaybe<Scalars['timestamp']['input']>;
...
export type Dbt_Store_B2b_Product = {
  ...
  id: Scalars['String']['output'];
  largest_bundle_price_in_cents: Maybe<Scalars['bigint']['output']>;
  /** An object relationship */
...
export type Dbt_Store_B2b_Product_Stream_Cursor_Value_Input = {
  id: InputMaybe<Scalars['String']['input']>;
  largest_bundle_price_in_cents: InputMaybe<Scalars['bigint']['input']>;
};
...
export type Dbt_Store_Bundle_Price = {
  ...
  min_quantity: Scalars['Int']['output'];
  /** An object relationship */
  product: Maybe<Dbt_Store_Base_Product>;
  product_id: Scalars['String']['output'];
  unit_price_in_cents: Scalars['bigint']['output'];
};
...
export type Dbt_Store_Bundle_Price_Stream_Cursor_Value_Input = {
  ...
  unit_price_in_cents: InputMaybe<Scalars['bigint']['input']>;
};
...
export type Dbt_Store_Exposed_Product = {
  ...
  total_quantity: Scalars['bigint']['output'];
...
export type Dbt_Store_Exposed_Product_Stream_Cursor_Value_Input = {
  ...
  total_quantity: InputMaybe<Scalars['bigint']['input']>;
...
export type FetchProductForNewOfferQuery = { __typename?: 'query_root', dbt_store_base_product: Array<{ __typename?: 'dbt_store_base_product', variants: Array<{ __typename?: 'dbt_store_base_product_variant', variant: { __typename?: 'dbt_store_exposed_product_variant', inventory_quantity: number, title: string } | null, b2bVariant: { __typename?: 'dbt_store_b2b_product_variant', price: any } | null }>, bundlePrices: Array<{ __typename?: 'dbt_store_bundle_price', unit_price_in_cents: number, min_quantity: number }>, exposedProduct: { __typename?: 'dbt_store_exposed_product', title: string, total_quantity: number } | null }> };
...
export type FetchB2BProductQuery = { __typename?: 'query_root', dbt_store_base_product: Array<{ __typename?: 'dbt_store_base_product', id: string, vendorId: any, exposedProduct: { __typename?: 'dbt_store_exposed_product', model: string | null, description: string | null, numberOfViews: number, brand: string | null, handle: string, id: string, productType: string, title: string } | null, b2bProduct: { __typename?: 'dbt_store_b2b_product', largest_bundle_price_in_cents: number | null } | null, images: Array<{ __typename?: 'dbt_store_exposed_product_image', src: string }>, variants: Array<{ __typename?: 'dbt_store_base_product_variant', exposedVariant: { __typename?: 'dbt_store_exposed_product_variant', title: string, condition: any | null, inventory_quantity: number } | null, b2bVariant: { __typename?: 'dbt_store_b2b_product_variant', price: any, compare_at_price: any | null } | null }>, tags: Array<{ __typename?: 'dbt_store_exposed_product_tag', tag: string, value: string }> }> };

export type FetchPriceOffersQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchPriceOffersQuery = { __typename?: 'query_root', PriceOffer: Array<{ __typename?: 'PriceOffer', id: string, buyerId: any, includedBuyerCommissionPercentage: any, createdAt: any, publicNote: string | null, quantity: number, status: any, newPriceInCents: number, productId: string, product: { __typename?: 'Product', storeExposedProduct: { __typename?: 'dbt_store_exposed_product', brand: string | null, productType: string, size: string | null, firstImage: string | null } | null } }> };


export const FetchProductForNewOfferDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"fetchProductForNewOffer"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dbt_store_base_product"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"variants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"variant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inventory_quantity"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"b2bVariant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"price"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"bundlePrices"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unit_price_in_cents"}},{"kind":"Field","name":{"kind":"Name","value":"min_quantity"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"exposedProduct"},"name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"total_quantity"}}]}}]}}]}}]} as unknown as DocumentNode<FetchProductForNewOfferQuery, FetchProductForNewOfferQueryVariables>;
export const FetchB2BProductDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"fetchB2BProduct"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productInternalId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dbt_store_base_product"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productInternalId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","alias":{"kind":"Name","value":"exposedProduct"},"name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"model"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"numberOfViews"}},{"kind":"Field","name":{"kind":"Name","value":"brand"}},{"kind":"Field","name":{"kind":"Name","value":"handle"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"productType"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"b2bProduct"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"largest_bundle_price_in_cents"}}]}},{"kind":"Field","name":{"kind":"Name","value":"images"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"src"}}]}},{"kind":"Field","name":{"kind":"Name","value":"variants"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"exposedVariant"},"name":{"kind":"Name","value":"variant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"condition"}},{"kind":"Field","name":{"kind":"Name","value":"inventory_quantity"}}]}},{"kind":"Field","name":{"kind":"Name","value":"b2bVariant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"compare_at_price"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tag"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"vendorId"}}]}}]}}]} as unknown as DocumentNode<FetchB2BProductQuery, FetchB2BProductQueryVariables>;
export const FetchPriceOffersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"fetchPriceOffers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"PriceOffer"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"createdAt"},"value":{"kind":"EnumValue","value":"desc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"buyerId"}},{"kind":"Field","name":{"kind":"Name","value":"includedBuyerCommissionPercentage"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"publicNote"}},{"kind":"Field","name":{"kind":"Name","value":"quantity"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"storeExposedProduct"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"brand"}},{"kind":"Field","name":{"kind":"Name","value":"productType"}},{"kind":"Field","name":{"kind":"Name","value":"size"}},{"kind":"Field","name":{"kind":"Name","value":"firstImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"newPriceInCents"}},{"kind":"Field","name":{"kind":"Name","value":"productId"}}]}}]}}]} as unknown as DocumentNode<FetchPriceOffersQuery, FetchPriceOffersQueryVariables>;