...
export const FetchPurchasesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'fetchPurchases' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<FetchPurchasesQuery, FetchPurchasesQueryVariables>;
export const FetchAccountPageCustomerDataDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  FetchAccountPageCustomerDataQueryVariables
>;
