...
export type SubscribeToOpenedPriceOfferSubscription = { __typename?: 'subscription_root', PriceOffer: Array<{ __typename?: 'PriceOffer', newPriceInCents: number, id: string, initiatedBy: any, status: any, discountCode: string | null }> };

export type HandDeliveryOrderLineFragmentFragment = { __typename?: 'OrderLines', shippingSolution: any, productVariant: { __typename?: 'ProductVariant', product: { __typename?: 'Product', id: string } } | null };
...
export type FetchConversationUserDetailsQuery = { __typename?: 'query_root', Customer: Array<{ __typename?: 'Customer', purchasedOrders: Array<{ __typename?: 'Order', orderLines: Array<{ __typename?: 'OrderLines', shippingSolution: any, productVariant: { __typename?: 'ProductVariant', product: { __typename?: 'Product', id: string } } | null }> }>, vendorSoldOrderLines: Array<{ __typename?: 'OrderLines', shippingSolution: any, productVariant: { __typename?: 'ProductVariant', product: { __typename?: 'Product', id: string } } | null }>, onlineProducts: Array<{ __typename?: 'Product', id: string }> }> };
...
export type AddFavoriteProductMutationVariables = Exact<{
  ...
  internalProductId: Scalars['String']['input'];
}>;
...
export const AddFavoriteProductDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"addFavoriteProduct"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"internalProductId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"insert_FavoriteProducts_one"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"object"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"customerId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"internalProductId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"internalProductId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<AddFavoriteProductMutation, AddFavoriteProductMutationVariables>;
export const RemoveFavoriteProductsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"removeFavoriteProducts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"internalProductId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"delete_FavoriteProducts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_and"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"customerId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"internalProductId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"internalProductId"}}}]}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}}]}}]}}]} as unknown as DocumentNode<RemoveFavoriteProductsMutation, RemoveFavoriteProductsMutationVariables>;
